...
// BitcoinNovaService - daemon config
type BitcoinNovaService struct {
...
// NewService - creates a BitcoinNovaService with the default options
func NewService() *BitcoinNovaService {
	service := &BitcoinNovaService{
...
// Start - starts the Bitcoinnova-service
func (service *BitcoinNovaService) Start() error {
	service.loadConfig()
	go service.pinger()
	go service.saver()
	service.scanner()
...
func (service *BitcoinNovaService) loadConfig() {
...
func (service *BitcoinNovaService) saver() {
...
func (service *BitcoinNovaService) scanner() {
...
func (service *BitcoinNovaService) pinger() {
...
func (service *BitcoinNovaService) isSynced() bool {
...
func (service *BitcoinNovaService) Save() {
	walletd.Save(
		service.RPCPassword,
		service.BindAddress,
		service.RPCPort,
...
func (service *BitcoinNovaService) updateData() {
...
func addTransaction(src, dest, hash, paymentID string, amount float64) {
	_, err := walletDB.Exec(`INSERT INTO transactions (addr_id, dest, hash, paymentID, amount)
			VALUES ((SELECT id FROM addresses WHERE address = $1),
				$2, $3, $4, $5);`, src, dest, hash, paymentID, amount/1000000)
	if err != nil {
		fmt.Println(err)
	}
}
